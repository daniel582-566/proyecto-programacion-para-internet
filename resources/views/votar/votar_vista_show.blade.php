                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-1 mb-3"> <!-- Gráfica -->
                            <h5 class="card-title text-center">Gráfica de votaciones</h5>
                            <hr>
                            <div class="mt-4 mb-2">
                                <div class="pb-3">
                                    @if ($votacion->votos == 0)
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="alert alert-light text-center" role="alert">
                                                ...
                                                <p class="mb-0"><i><a href="#">Contacta al soporte o recarge la pagina</a> si crees que se trata de un error.</i></p>
                                            </div>
                                        </div>
                                    @else
                    ...
                    <div class="d-flex justify-content-center"> <!-- Formulario de votación -->
                        <div class="d-flex justify-content-between mb-4 pe-2">
                            <a href="{{ route('votar.index') }}" class="btn btn-secondary mx-2">regresar</a>
