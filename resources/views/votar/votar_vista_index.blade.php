            ...
            <div class="col-sm-12 col-md-12 col-lg-11 col-xl-11">
                @if ($votaciones->isEmpty())
                    <div class="alert alert-danger text-center" role="alert">
                        ...
                        <p class="mb-0"><i><a href="#">Contacta al soporte o recargue la pagina</a> si crees que se trata de un error.</i></p>
                    </div>
                @else
                                                ...
                                                @if ($votacion->votos == 0)
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="alert alert-primary text-center" role="alert">
                                                            ...
                                                            <p class="mb-0"><i><a href="#">Contacta al soporte o recargue la pagiina</a> si crees que se trata de un error.</i></p>
                                                        </div>
                                                    </div>
                                                @else
