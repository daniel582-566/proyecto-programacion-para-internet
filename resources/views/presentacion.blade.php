    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="pagetitle col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <img src="{{ asset('NiceAdmin/assets/img/logo.png') }}" alt="Logo Votacioncucei" />
            </div>
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <h2 class="">PAGINA DE VOTACIONES CUCEI</h2>
            </div>
        </div>
        <hr />
    </div>
    ...
    <div class="row">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">VOTACION</h5>
                                        <p class="card-text">Vota de manera <b><i>fácil y segura</i></b>
                                            PARA TU UNIVERSIDAD CUCEI</p>
                                    </div>
                                </div>
                            </div>
                            <!-- News -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Infórmate de las noticias del momento con nuestro <i>sistema de
                                                noticias</i> basado en tus preferencias.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><b>Comparte</b> tus propias propuestas en un foro al
        ...
        <div class="col-sm-12 col-md-7 col-lg-8 col-xl-8">
            ...
            <section class="row justify-content-center align-items-center">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Últimas votaciones electorales 2022</h5>
    ...
    <section>
        <div class="row justify-content-center">
            ...
            <div class="card col-sm-12 col-md-6 col-lg-5 col-xl-5 mx-2">
                <div class="card-body">
                    <h5 class="card-title">Noticias</h5>
                    <h6 class="card-subtitle mb-2 text-muted">Infórmate de lo que está pasando a tu alrededor.</h6>
                    <p class="card-text">Ingresa a ver las noticias más relevantes de CUCEI y filtra tus búsquedas por
            ...
            <div class="card col-sm-12 col-md-6 col-lg-5 col-xl-5 mx-2">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Las votaciones más importantes de CUCEI.</h6>
                    <p class="card-text">Vota por tus candidatos elegidos y acerca de las propuestas de ley que consideres importantes para tu universidad</p>
                    <div class="text-center">
